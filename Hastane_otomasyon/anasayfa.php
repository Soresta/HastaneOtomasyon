...
<div class="orta_div" id="randevu_div">
    ...
    <select name="hastane" class="hastane">
        ...
        <option value="Ak Damar Hastanesi">Ak Damar Hastanesi</option>
    ...
    <select name="doktor" class="doktor">
        ...
        <option value="Şeyma Karaca">Şeyma Karaca</option>
        <option value="Alperen Çelik">Alperen Çelik</option>
        <option value="Hazar Yusuf">Hazar Yusuf</option>
        <option value="Furkan demir">Furkan demir</option>
    </select>
